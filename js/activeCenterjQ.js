window.onload=function show() {
   ...
   //---------------------------------jQuery分割线------------------------------------
	...
	$("div[class=w]").children().mouseover(function(){
		var $content=$(this).children("span").children("a").eq(2).html();
		var $newDiv=$("<div></div>").html("<a href='#' style='font-size: 17px;color: white;text-decoration: underline'>点击参加活动</a>" +
	                "<br><a href='#' style='font-size: 14px;color: white'>" + $content + "</a>").addClass("ghostGreen");
	    if($(this).children("span").children().length<4){        
	        $(this).children("span").append($newDiv);
	    }
	    $(this).children("span").children("div").stop(true).animate({
	        	"bottom": -10
	    },100);
	    console.log();
	});
	$("div[class=w]").children().mouseout(function(){
		$(this).children("span").children("div").stop(true).animate({
	        	"bottom": -275
	        },100);
	});
